...
class DoubleAgent(Agent):
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, params=None, seed=1234, phase='training'):
    ...
    def learn(self, experiences, gamma):
        ...
        Q_targets_next = self.qnetwork_target(next_states).gather(  # Double DQN
            1, self.qnetwork_local(next_states).argmax(dim=1, keepdim=True)
        ).detach()
