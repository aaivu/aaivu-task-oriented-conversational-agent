...
class DQNAgent(Agent):
    ...
    def state_to_action(self, state):
        ...
        if self.running_phase == "inference":
            self.action = self.apply_policy(self.representation)
        else:
    ...
    def prepare_state_representation(self, state):
        ...
        self.final_representation = np.hstack(
            [user_act_rep, user_inform_slots_rep, user_request_slots_rep, agent_act_rep,
             agent_inform_slots_rep, agent_request_slots_rep, current_slots_rep, turn_rep, turn_onehot_rep,
