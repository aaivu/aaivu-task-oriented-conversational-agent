...
kb = KBHelper(movie_kb)
kb.fill_inform_slots({'starttime': 'PLACEHOLDER'}, {'inform_slots': {'moviename': 'deadpool'}, 'request_slots': {'date': 'UNK'}, 'proposed_slots': {}, 'agent_request_slots': {}}
)
"""
