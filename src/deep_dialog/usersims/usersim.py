...
class UserSimulator:
    ...
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, start_set=None, params=None, print_utt=False):
        ...
        self.print_utt = params['print_mode']
    ...
    def add_nl_to_action(self, user_action):
        ...
        if self.simulator_act_level == 1:
            user_nlu_res = self.nlg_model.generate_dia_act(user_action['nl']) # NLU
