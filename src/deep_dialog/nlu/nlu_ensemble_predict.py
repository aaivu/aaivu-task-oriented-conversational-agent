from deep_dialog.nlu import pipeline_ensemble as pe

model_folder_path = "deep_dialog/nlu/stack_models/pipelines"
model_score_path = "deep_dialog/nlu/results/pipelines"
evaluation_dataset_path = "deep_dialog/nlu/data/test_data.csv"
