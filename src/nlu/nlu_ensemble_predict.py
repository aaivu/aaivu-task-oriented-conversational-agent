...
class NluEnsemblePredict:
    ...
    def __init__(
        ...
        modelscores = pe.ModelScores(model_score_path,model_folder_path=model_folder_path,evaluation_dataset_path=evaluation_dataset_path)
    ...
    def run_stack_pipelines(self, sentence):
        return pe.model_stack_predict(sentence, self.stack_models, self.model_scores,self.model_entity_scores)
